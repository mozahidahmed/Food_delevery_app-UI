            ...
            <div className="hero  ">
                <div className="hero-content text-center py-24">
                    ...
                    <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-2 mt-6">
                            <button className="btn rounded-full  text-white font-bold hover:bg-[#FA4A0C]  bg-[#FA4A0C]">Get Started</button>
                            <button className="btn btn-outline  text-white font-bold hover:bg-[#FA4A0C]  rounded-full ">Get Started</button>
                    </div>
                    </div>
                </div>
            </div>
